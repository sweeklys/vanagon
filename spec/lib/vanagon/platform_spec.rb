    ...
    [
      {
        ...
        :os_version                     => "6",
        :architecture                   => "i386",
        :output_dir                     => "deb/debian6/",
        :output_dir_with_target         => "deb/debian6/thing",
        :output_dir_empty_string        => "deb/debian6/",
        :source_output_dir              => "deb/debian6/",
        :source_output_dir_with_target  => "deb/debian6/thing",
        :source_output_dir_empty_string => "deb/debian6/",
        :is_rpm                         => false,
        :is_el                          => false,
        :block                          => %Q[
